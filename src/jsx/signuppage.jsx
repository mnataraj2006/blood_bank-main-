...
const LifeShareSignup= () => {
  ...
  const googleLogin = useGoogleLogin({
    ...
    onSuccess: async (tokenResponse) => {
      try {
        ...
        const checkResponse = await fetch("${import.meta.env.VITE_API_URL || 'https://blood-bank-backend.onrender.com'}/auth/google/check-user", {
          method: "POST",
  ...
  const handleSubmit = async(e) => {
    ...
    const res = await fetch("${import.meta.env.VITE_API_URL || 'https://blood-bank-backend.onrender.com'}/signup", {
      method: "POST",
      headers: { "Content-Type": "application/json" },
