...
const BookDonationSlot = () => {
  ...
  useEffect(() => {
    ...
    if (storedUser && storedUser.id) {
      ...
      axios.get(`${import.meta.env.VITE_API_URL || 'https://blood-bank-backend.onrender.com'}/requests/donor/${storedUser.id}`)
    ...
    axios.get(`${import.meta.env.VITE_API_URL || 'https://blood-bank-backend.onrender.com'}/hospitals/verified`)
      .then(res => {
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      const response = await axios.post(`${import.meta.env.VITE_API_URL || 'https://blood-bank-backend.onrender.com'}/appointments/book`, appointmentData, {
