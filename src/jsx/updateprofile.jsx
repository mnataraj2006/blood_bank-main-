...
const UpdateProfile = () => {
  ...
  useEffect(() => {
    const fetchProfile = async () => {
      ...
      try {
        const response = await axios.get(`${import.meta.env.VITE_API_URL || 'https://blood-bank-backend.onrender.com'}/user/${storedUser.id}`);
      ...
      try {
        const countResponse = await axios.get(`${import.meta.env.VITE_API_URL || 'https://blood-bank-backend.onrender.com'}/donations/count/${storedUser.id}`);
  ...
  const handleSave = async () => {
    ...
    try {
      const storedUser = JSON.parse(localStorage.getItem('user'));
      await axios.patch(`${import.meta.env.VITE_API_URL || 'https://blood-bank-backend.onrender.com'}/user/${storedUser.id}`, profile);
