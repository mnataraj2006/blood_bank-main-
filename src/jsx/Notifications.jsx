...
const Notifications = () => {
  ...
  const fetchNotifications = async () => {
    try {
      ...
      const response = await axios.get(`${import.meta.env.VITE_API_URL || 'https://blood-bank-backend.onrender.com'}/notifications/${storedUser.id}`);
    ...
    try {
      ...
      await Promise.all(
        unreadNotifications.map(notif =>
          axios.patch(`${import.meta.env.VITE_API_URL || 'https://blood-bank-backend.onrender.com'}/notifications/${notif._id}/read`)
        )
      );
      setNotifications(prev =>
  ...
  const deleteNotification = async (notificationId, e) => {
    e.stopPropagation();
    try {
      await axios.delete(`${import.meta.env.VITE_API_URL || 'https://blood-bank-backend.onrender.com'}/notifications/${notificationId}`);
