...
const AdminDashboard = () => {
  ...
  const fetchAdminData = async () => {
    try {
      ...
      // Fetch stats
      const statsRes = await axios.get(`${import.meta.env.VITE_API_URL || 'https://blood-bank-backend.onrender.com'}/admin/stats`);
      setStats(statsRes.data);

      // Fetch users
      const usersRes = await axios.get(`${import.meta.env.VITE_API_URL || 'https://blood-bank-backend.onrender.com'}/admin/users`);
      setUsers(usersRes.data);

      // Fetch donations
      const donationsRes = await axios.get(`${import.meta.env.VITE_API_URL || 'https://blood-bank-backend.onrender.com'}/admin/donations`);
      setDonations(donationsRes.data);

      // Fetch requests
      const requestsRes = await axios.get(`${import.meta.env.VITE_API_URL || 'https://blood-bank-backend.onrender.com'}/admin/requests`);
      setRequests(requestsRes.data);

      // Fetch hospitals
      const hospitalsRes = await axios.get(`${import.meta.env.VITE_API_URL || 'https://blood-bank-backend.onrender.com'}/admin/hospitals`);
      setHospitals(hospitalsRes.data);

      // Fetch matches
      const matchesRes = await axios.get(`${import.meta.env.VITE_API_URL || 'https://blood-bank-backend.onrender.com'}/admin/matches`);
      setMatches(matchesRes.data);



      // Fetch blood inventory
      const inventoryRes = await axios.get(`${import.meta.env.VITE_API_URL || 'https://blood-bank-backend.onrender.com'}/admin/blood-inventory`);
      setBloodInventory(inventoryRes.data);

      // Fetch plasma inventory
      try {
        const plasmaRes = await axios.get(`${import.meta.env.VITE_API_URL || 'https://blood-bank-backend.onrender.com'}/admin/plasma-inventory`);
      ...
      switch (action) {
        ...
        case 'delete':
          if (window.confirm('Are you sure you want to delete this user? This action cannot be undone.')) {
            await axios.delete(`${import.meta.env.VITE_API_URL || 'https://blood-bank-backend.onrender.com'}/admin/users/${userId}`);
            await fetchAdminData(); // Refresh data
            alert('User deleted successfully');
          }
          break;
        case 'activate':
          await axios.patch(`${import.meta.env.VITE_API_URL || 'https://blood-bank-backend.onrender.com'}/admin/users/${userId}`, { status: 'active' });
          await fetchAdminData();
          break;
        case 'deactivate':
          await axios.patch(`${import.meta.env.VITE_API_URL || 'https://blood-bank-backend.onrender.com'}/admin/users/${userId}`, { status: 'inactive' });
          await fetchAdminData();
          break;
      }
    } catch (error) {
  ...
  const handleAddHospital = async (e) => {
    ...
    try {
      ...
      await axios.post(`${import.meta.env.VITE_API_URL || 'https://blood-bank-backend.onrender.com'}/admin/hospitals`, hospitalData);
      setNewHospital({
        name: '',
        address: '',
        city: '',
  ...
  const handleVerifyHospital = async (hospitalId, verified) => {
    try {
      await axios.patch(`${import.meta.env.VITE_API_URL || 'https://blood-bank-backend.onrender.com'}/admin/hospitals/${hospitalId}/verify`, { verified });
      await fetchAdminData(); // Refresh hospitals list
  ...
  const handleDeleteHospital = async (hospitalId) => {
    if (window.confirm('Are you sure you want to delete this hospital? This action cannot be undone.')) {
      try {
        await axios.delete(`${import.meta.env.VITE_API_URL || 'https://blood-bank-backend.onrender.com'}/admin/hospitals/${hospitalId}`);
        await fetchAdminData(); // Refresh hospitals list
      ...
      switch (action) {
        case 'complete':
          if (window.confirm('Are you sure you want to mark this match as completed?')) {
            await axios.patch(`${import.meta.env.VITE_API_URL || 'https://blood-bank-backend.onrender.com'}/admin/matches/${matchId}`, { status: 'completed' });
