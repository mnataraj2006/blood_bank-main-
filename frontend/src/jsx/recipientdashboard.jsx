...
const RecipientDashboard = () => {
  ...
  axios.get(`${import.meta.env.VITE_API_URL || 'https://blood-bank-backend.onrender.com'}/api/recipients/${userId}`)
    .then((res) => setRecipientProfile(res.data))
    .catch((err) => console.error("❌ Error fetching profile:", err));

  // Fetch all requests once
  axios.get(`${import.meta.env.VITE_API_URL || 'https://blood-bank-backend.onrender.com'}/requests/${userId}`)
    .then((res) => {
  ...
  axios.get(`${import.meta.env.VITE_API_URL || 'https://blood-bank-backend.onrender.com'}/responses/${userId}`)
  ...
  const handleAcceptResponse = async (responseId) => {
    ...
    try {
      const response = await axios.patch(`${import.meta.env.VITE_API_URL || 'https://blood-bank-backend.onrender.com'}/responses/${responseId}`, {
      ...
      const storedUser = JSON.parse(localStorage.getItem("user"));
      if (storedUser && storedUser.id) {
        const res = await axios.get(`${import.meta.env.VITE_API_URL || 'https://blood-bank-backend.onrender.com'}/responses/${storedUser.id}`);
