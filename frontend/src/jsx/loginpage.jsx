...
const LoginPage = () => {
  ...
  const googleLogin = useGoogleLogin({
    onSuccess: async (tokenResponse) => {
      try {
        ...
        const loginResponse = await fetch(`${import.meta.env.VITE_API_URL || 'https://blood-bank-backend.onrender.com'}/auth/google-login`, {
          method: "POST",
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      const endpoint = isAdminLogin ?
        `${import.meta.env.VITE_API_URL || 'https://blood-bank-backend.onrender.com'}/admin/login` :
        `${import.meta.env.VITE_API_URL || 'https://blood-bank-backend.onrender.com'}/login`;
  ...
  const handlePasswordSetup = async (e) => {
    ...
    try {
      const response = await fetch(`${import.meta.env.VITE_API_URL || 'https://blood-bank-backend.onrender.com'}/auth/set-password`, {
        method: "POST",
        headers: { "Content-Type": "application/json" },
        body: JSON.stringify({
